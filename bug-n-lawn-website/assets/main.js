...
document.querySelectorAll("[data-chat-launcher]").forEach((button) => {
  button.addEventListener("click", () => {
    if (window.Tawk_API && typeof window.Tawk_API.maximize === "function") {
      window.Tawk_API.maximize();
      return;
    }
    window.open("https://tawk.to/chat/696330a64c1a01197bd21efa/1jelnc2es", "_blank", "noopener,noreferrer");
  });
});
